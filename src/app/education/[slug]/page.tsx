...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
    ...
    return {
        title: yoast_head_json?.title || courseOffer.title.rendered,
        description: yoast_head_json?.og_description || "",
        openGraph: {
            title: yoast_head_json?.og_title || courseOffer.title.rendered,
            description: yoast_head_json?.og_description || "",
            ...
            url: yoast_head_json?.og_url || courseOffer.link,
            type: "article",
            images:
